...
class PluginBase(object):
    ...
    def execute(self, request: FakeReq, response: FakeResp):
        ...
        try:
            ...
            # 暂时先pass这个错误
            # refer：https://github.com/boy-hack/webscan/labels/Requests%20UnicodeDecodeError
            pass
        except UnicodeError:
            # https://github.com/w-digital-scanner/webscan/issues/238
            # bypass unicode奇葩错误
            pass
        except (
            ...
            # refer: https://github.com/boy-hack/webscan/labels/requests.exceptions.InvalidURL
            # 奇葩的ContentDecodingError
            # refer:https://github.com/boy-hack/webscan/issues?q=label%3Arequests.exceptions.ContentDecodingError
            pass
