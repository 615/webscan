...
class FakeReq(object):
    ...
    def __init__(self, url, headers: dict, method=HTTPMETHOD.GET, data="", do_cookies=dict):
    ...
    @property
    def do_cookies(self) -> dict:
        return self._do_cookies
